  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      try {
        ...
        print('Warning: Failed to load wallet: $e');
      }

      // Load menu (non-critical, use fallback if fails)
      List<MenuModel> todayMenu = [];
      try {
        todayMenu = await widget.apiService.getTodayMenu();
      } catch (e) {
        print('Warning: Failed to load menu: $e');
      }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Buy Token button (always visible)
                    SizedBox(
                      ...
                      child: FilledButton.icon(
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  PurchaseScreen(apiService: widget.apiService),
                            ),
                          );
                        },
